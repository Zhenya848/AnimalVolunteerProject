...
namespace PetProject.Application.Volunteers.Commands
{
    public class VolunteerService
        : ICommandService<Result<Guid, ErrorList>, CreateVolunteerCommand, DeleteVolunteerCommand, UpdateVolunteerCommand>
    {
