...
namespace PetProject.Application.Volunteers.Pets.Commands
{
    public class PetService : ICommandService<Result<Guid, ErrorList>, CreatePetCommand, DeletePetCommand, UpdatePetCommand>
    {
        ...
        public Task<Result<Guid, ErrorList>> Delete(DeletePetCommand request, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        public Task<Result<Guid, ErrorList>> Update(UpdatePetCommand request, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
