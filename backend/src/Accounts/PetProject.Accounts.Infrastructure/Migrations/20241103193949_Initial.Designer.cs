...
namespace PetProject.Infrastructure.Authentification.Migrations
{
    ...
    [Migration("20241103193949_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetProject.Accounts.Domain.User.AdminAccount", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "PetProject.Accounts.Domain.User.AdminAccount.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("PetProject.Accounts.Domain.User.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uuid")
                        .HasColumnName("role_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("PetProject.Accounts.Domain.User.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PetProject.Accounts.Domain.User.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PetProject.Accounts.Domain.User.RolePermission", b =>
                {
                    b.HasOne("PetProject.Accounts.Domain.User.Permission", "Permission")
                        .WithMany()
                    ...
                    b.HasOne("PetProject.Accounts.Domain.User.Role", "Role")
